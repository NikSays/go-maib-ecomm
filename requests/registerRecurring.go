...
const (
	// RegisterRecurringSMS is a recurring transaction type which is initialized
	// with an SMS transaction (-z). The resulting transaction should be confirmed
	// with TransactionStatus (-c).
	//
	// This is the default transaction type.
	RegisterRecurringSMS RegisterRecurringType = iota

	// RegisterRecurringDMS is a recurring transaction type which is initialized
	// with a DMS transaction (-d). The resulting transaction should be confirmed
	// with TransactionStatus (-c), and executed with ExecuteDMS (-t).
...
// String converts RegisterRecurringType into the ECommerce command. Returns an
...
type RegisterRecurring struct {
	...
	// Identifier of the recurring payment. If not specified, resulting
	// TRANSACTION_ID will be used as the recurring payment ID.
	...
	// Whether the recurring transaction with a given BillerClientID should be
